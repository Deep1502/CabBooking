<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="CabBooking.login" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            If you are driver then <asp:HyperLink ID="hl_Driver_Login" runat="server" NavigateUrl="~/driverlogin.aspx">Click here</asp:HyperLink> to login.
            <br />
            If you are admin then <asp:HyperLink ID="hl_Admin_Login" runat="server" NavigateUrl="~/adminlogin.aspx">Click here</asp:HyperLink> to login.
            <br />
        </div>
    </form>
</body>
